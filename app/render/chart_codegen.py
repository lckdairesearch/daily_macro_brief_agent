...
def generate_chart_code(
    ...
    user_msg = (
        ...
        "- The shared `dates` is the union of all series dates — use it ONLY for x-axis tick setup.\n"
        "- Use simple plotting logic. Prefer readability over clever overlap handling.\n\n"
