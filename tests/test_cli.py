...
def test_parse_data_cutoff_naive_uses_app_timezone():
    cutoff = _parse_data_cutoff("2026-05-08 08:00", ZoneInfo("Asia/Hong_Kong"))

    assert cutoff == datetime(2026, 5, 8, 8, 0, tzinfo=ZoneInfo("Asia/Hong_Kong"))
...
def test_parse_data_cutoff_zulu_converts_to_app_timezone():
    cutoff = _parse_data_cutoff("2026-05-08T00:00:00Z", ZoneInfo("Asia/Hong_Kong"))
